  ...
  <div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <ul>
        ...
        <li><a href="src/view/createClient.php"><i class="fas fa-user-tie"></i>Creer un Client</a></li>
        <li><a href="src/view/createAccount.php"><i class="fas fa-address-card"></i>Creer un Compte</a></li>
        <li><a href="javascript:return false;" onclick="alert('<h1>COMMING SOON</h1>');"><i class="fas fa-exchange-alt"></i>Faire un Virement</a></li>
      </ul>
    ...
    <div class="main_content">
      <div class="header">
        <div class="next_nav">
          ...
          <div class="display_header">
            <h4>BANQUE DU PEUPLE <span class="breadcrumb">>> Accueil</span></h4>
          </div>
      ...
      <!-- // CONTENU CENTRAL :  -->
      <div class="info">
        <img class="homeDisplayImg" src="public/img/home.jpg" alt="ACCUEIL">
      </div>
      <!-- FIN CONTENU CENTRAL -->
    </div>
    <!-- ENDING MAIN CONTENT -->
